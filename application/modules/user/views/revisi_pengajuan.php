					...
					<div class="col-6">
						<div class="card card-primary">
							...
							<div class="form-group">
									...
									<input type="text" name="pnama" id="pemohon_nama" class="form-control" required edite value="<?= $data['pemohon_nama']; ?>">
								</div>
							
								<div class="form-group">
									<label for="nikpemohon">NIK Pemohon</label>
									<input type="number" name="pnik" id="pemohon_nik" class="form-control" required edite value="<?= $data['pemohon_nik']; ?>">
								</div>
